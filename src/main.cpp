...
unsigned int nStakeMinAge = 30 * 60; // 30 min
...
const string strMessageMagic = "1MillionCoin Signed Message:\n";
...
#ifdef ENABLE_WALLET
// 1MillionCoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("1MillionCoin-loadblk");
