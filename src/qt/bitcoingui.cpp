    ...
    nWeight(0)
{
    //resize(970, 570);
	resize(1080, 662);
    setWindowTitle(tr("1MillionCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("1MillionCoin");
    setStyleSheet("#1MillionCoin { background-color: #f9f9f9);  }"
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a 1MillionCoin address"));
    ...
    masternodeManagerAction->setToolTip(tr("Show 1MillionCoin Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About 1MillionCoin"), this);
    aboutAction->setToolTip(tr("Show information about 1MillionCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for 1MillionCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("1MillionCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("1MillionCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 1MillionCoin network", "", count));
}
...
{
    QString strTitle = tr("1MillionCoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid 1MillionCoin address or malformed URI parameters."));
    }
