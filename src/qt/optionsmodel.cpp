...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymize1MillionCoinAmount"))
        settings.setValue("nAnonymize1MillionCoinAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymize1MillionCoinAmount = settings.value("nAnonymize1MillionCoinAmount").toLongLong();
    ...
    if (settings.contains("nAnonymize1MillionCoinAmount"))
        SoftSetArg("-anonymize1MillionCoinamount", settings.value("nAnonymize1MillionCoinAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymize1MillionCoinAmount:
            nAnonymize1MillionCoinAmount = value.toInt();
            settings.setValue("nAnonymize1MillionCoinAmount", nAnonymize1MillionCoinAmount);
            emit anonymize1MillionCoinAmountChanged(nAnonymize1MillionCoinAmount);
            break;
        default:
            break;
        }
